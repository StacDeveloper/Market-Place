        ...
        <div className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">  
                ...
                <h2 className="text-2xl md:text-4xl font-medium mt-2 leading-[1.2]">
                    Sell your Social Accouts <br />
                    <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">with Confidence </span> 
                    & Earn Money
                </h2>
                <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">We are the leading social media marketplace that conencts brands with their customers With our user-friendly interface.</p>
